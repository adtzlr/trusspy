...
with M.Elements as ME:
    ME.add_element( 1, conn=(1,7), gprop=[1.] )
    ME.add_element( 2 ,conn=(4,7), gprop=[1.] )
    ME.add_element( 3, conn=(2,8), gprop=[1.] )
    ME.add_element( 4, conn=(5,8), gprop=[1.] )
    ME.add_element( 5, conn=(3,9), gprop=[1.] )
    ME.add_element( 6, conn=(6,9), gprop=[1.] )
    ME.add_element( 7, conn=(7,8), gprop=[1.] )
    ME.add_element( 8, conn=(8,9), gprop=[1.] )
    ME.add_element( 9, conn=(1,8), gprop=[1.] )
    ME.add_element(10, conn=(4,8), gprop=[1.] )
    ME.add_element(11, conn=(3,8), gprop=[1.] )
    ME.add_element(12, conn=(6,8), gprop=[1.] )
