...
E1 = tp.Element(
    1, [1, 2], material_properties=[1, 0.1, 0.1], geometric_properties=[1], mat_type=2
)
E2 = tp.Element(
    2, [2, 3], material_properties=[1, 0.1, 0.1], geometric_properties=[1], mat_type=2
)
E3 = tp.Element(
    3, [3, 4], material_properties=[1, 0.1, 0.1], geometric_properties=[1], mat_type=2
)
E4 = tp.Element(
    4, [4, 5], material_properties=[1, 0.1, 0.1], geometric_properties=[1], mat_type=2
)
E5 = tp.Element(
    5, [5, 6], material_properties=[1, 0.1, 0.1], geometric_properties=[1], mat_type=2
)
...
fig0, ax0 = M.plot_model(
    config=["undeformed"], view="xz", lim_scale=(-5, 5, -8, 1), force_scale=1.0, inc=0
)
