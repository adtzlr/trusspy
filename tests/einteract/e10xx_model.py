...
for i in range(1,nnodes):  
    E = tp.Element( i, [i,i+1], material_properties=[100,80,1], geometric_properties=[1], mat_type=2)
    EE.append(E)
...
# path plot
fig3, ax3 = M.plot_path(nodepath=range(1,nnodes+1),increment=-1,Y='Displacement Z')
fig3, ax3 = M.plot_path(nodepath=range(1,nnodes+1),increment=-2,Y='Displacement Z',fig=fig3,ax=ax3)
