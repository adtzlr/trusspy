...
.. image:: examples/eNTA-A/model_undeformed_inc0_xz.png
   :width: 32%
   :alt: XZ-view on the undeformed model (Example NTA-A).
.. image:: examples/eNTA-A/model_contour-force_inc40_xz.png
   :width: 32%
   :alt: XZ-view on the deformed model (Example NTA-A, Inc.40).
.. image:: examples/eNTA-A/history_node45_DispZ-LPF.*
   :width: 32%
